...
When the User searches for 'Gwyn Endurance Tee' to select 'Green','M','4' and add to the cart
...
When the User searches for 'Gwyn Endurance Tee' to select 'Yellow','S','1' and add to the cart
